    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int y = 0; y < 16; y++)
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    highest = highest < data[y, i] ? data[y, i] : highest;
                    lowest = lowest < data[y, i] ? lowest : data[y, i];
                }
                result += highest - lowest;
            }

            Console.WriteLine("Corruption Checksum Part 1: " + result);
            ...
            for (int y = 0; y < 16; y++)
            {
                for (int i = 0; i < 16; i++)
                {
                    ...
                    while (true)
                    {
                        if (data[y, i] % data[y, temp] == 0 && temp != i)
                        {
                            result += data[y, i] / data[y, temp];
                            break;
                        }
                        ++temp;
                        if (temp == 16)
            ...
            Console.WriteLine("Corruption Checksum Part 2: " + result);
            Console.Read();
        }
    }
}
